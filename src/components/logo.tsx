...
const Logo = ({ className }: { className?: string }) => {
  return (
    <a href="/" className={cn('flex items-center gap-2.5 no-underline', className)}>
      <svg
      ...
      <span className='text-lg sm:text-xl font-bold text-[#15803d] tracking-tight'>
        Family Camping <span className='text-[#15803d]'>Hub</span>
      </span>
    </a>
  )
}
